...
{
  new (message_memory) ros2_custom_msgs::msg::RobotStatus(_init);
}

void RobotStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_custom_msgs::msg::RobotStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotStatus_message_member_array[4] = {
  {
    ...
    offsetof(ros2_custom_msgs::msg::RobotStatus, robot_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_custom_msgs::msg::RobotStatus, battery_level),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_custom_msgs::msg::RobotStatus, is_active),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_custom_msgs::msg::RobotStatus, mission_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotStatus_message_members = {
  "ros2_custom_msgs::msg",  // message namespace
  "RobotStatus",  // message name
  4,  // number of fields
  sizeof(ros2_custom_msgs::msg::RobotStatus),
...
{
  return &::ros2_custom_msgs::msg::rosidl_typesupport_introspection_cpp::RobotStatus_message_type_support_handle;
}
